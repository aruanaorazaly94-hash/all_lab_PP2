...
def level_up(score):
    ...
    level = count+1
    if level > kek:
        pygame.mixer.Channel(3).play(pygame.mixer.Sound("./music/levelup.mp3"))
...
while exit:
    ...
    if snake_position[0] == fruit_position[0] and snake_position[1] == fruit_position[1]:
        ...
        level_up(score)
        fruit_spawn = False
        pygame.mixer.Channel(0).play(pygame.mixer.Sound("./music/eating.mp3"))
    else:
        snake_body.pop()
    ...
    if fruit_color == green:
        ...
        if seconds > 4.5:
            ...
            pygame.mixer.Channel(1).play(
                pygame.mixer.Sound("./music/dissapear.mp3"))
    ...
    for block in snake_body[1:]:
        if snake_position[0] == block[0] and snake_position[1] == block[1]:
            pygame.mixer.Channel(5).play(pygame.mixer.Sound("./music/death.mp3"))
            game_over()
